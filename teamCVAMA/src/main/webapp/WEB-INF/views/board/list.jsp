...
<div class="container">
	...
	<c:forEach items="${list }" var="dto">
		<tr class="dataRow">
			...
			<td>
			<c:forEach begin="1" end="${dto.groupLayer }">&nbsp; &nbsp; &nbsp;</c:forEach>
	...
	<!-- 글쓰기 버튼 -->
			<tr>
				<td colspan="5">
					...
					<a href="plist.do?page=1&perPageNum=${pageObject.perPageNum }" class="btn btn-primary">인기글</a>
					<c:if test="${param.word !=null }"><a href="list.do?page=1&perPageNum=${pageObject.perPageNum }" class="btn btn-default">전체글 보기</a></c:if>
				</td>
			</tr>
			<!-- 페이지를 이동시키는 페이지네이션 -->
			<tr>
